...
public class MyAdapter  extends ArrayAdapter {
    ...
    public MyAdapter(@NonNull Context context, int resource, @NonNull List<Number> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.custom_num_layout, parent, false);
        ...
        Number numbers = list.get(position);
